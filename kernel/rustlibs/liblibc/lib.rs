...
pub use types::common::c95::{c_void, fpos_t};
...
pub use funcs::c95::stdlib::{free, malloc, realloc};


pub use funcs::c95::stdlib::{abs, atof, atoi};
pub use funcs::c95::stdlib::{strtoul};
