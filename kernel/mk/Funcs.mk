...
$(eval $(1)_CRATE := $(BUILD_DIR)/libs/$(shell $(RUST) --print-file-name $(2)/lib.rs))
endef
...
.PHONEY:
clean-$(1):
	$$(HIDE_SIGIL) rm -f $$(BUILD_DIR)/external/$(notdir $(3)) 2>/dev/null
...
$(call crate-name,$(2)) : $$(shell find $(1) -type f -name "*.rs") \
                          $$(foreach l,$(3), $$(call crate-name,$$(l))) \
                        | $$(dir $$(call crate-name,$(2)))
	@ echo "[RS  ] Compiling \"kernel/$(1)/lib.rs\"..." # for \"kernel/$$@\""
	$$(HIDE_SIGIL) $$(RUST) $$(RSFLAGS) $(4) $(1)/lib.rs --out-dir $$(BUILD_DIR)/libs

$(call doc-name,$(2)) : $$(shell find $(1) -type f -name "*.rs") \
						$$(foreach l,$(3), $$(call crate-name,$$(l)))
	@ echo "[RDOC] Documenting \"kernel/$(1)\"..."
	$$(HIDE_SIGIL) $$(RUSTDOC) $$(RDFLAGS) $(5) --output $(DOC_DIR) $(1)/lib.rs
